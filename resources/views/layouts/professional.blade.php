...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .btn { display: inline-flex; align-items: center; justify-content: center; gap: .5rem; padding: .72rem 1rem; border: 1px solid transparent; border-radius: 999px; font: inherit; font-weight: 700; text-decoration: none; cursor: pointer; transition: transform .18s ease, box-shadow .18s ease, background .18s ease; }
        ...
        .alert { display: flex; gap: .75rem; align-items: flex-start; padding: .95rem 1rem; border-radius: 16px; margin-bottom: 1rem; border: 1px solid transparent; }
        ...
        .stat-box { padding: 1rem 1.1rem; border-radius: 18px; background: linear-gradient(180deg, rgba(255,255,255,.96), rgba(248,250,252,.96)); border: 1px solid var(--line); box-shadow: var(--shadow-sm); }
        ...
        footer { width: 100%; padding: 1.1rem 0 1.4rem; color: var(--muted); text-align: center; font-size: .9rem; }
        .score-card { background: linear-gradient(135deg, rgba(15,118,110,.96), rgba(8,145,178,.96)); color: #fff; padding: 1.5rem; border-radius: 24px; box-shadow: var(--shadow); }
